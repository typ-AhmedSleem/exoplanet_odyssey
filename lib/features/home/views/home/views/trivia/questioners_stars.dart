...
class StarsAq extends StatelessWidget {
  StarsAq({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: AppbarScreen(text1: ' Questioners from', text2: 'Stares',imagebackgrond: 'assets/images/WhatsApp Image 2024-10-02 at 20.23.17_4c263e3f.jpg',)),
